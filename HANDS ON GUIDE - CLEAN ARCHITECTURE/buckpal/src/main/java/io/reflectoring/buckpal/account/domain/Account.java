...
public class Account {
	...
	public static Account withId(
		...
		return new Account(accountId, baselineBalance, activityWindow);
		 ...
		 //Optional : it helpt to void use get() method
	public Optional<AccountId> getId(){
		return Optional.ofNullable(this.id); // ofNullable : it allows to get an instance the specified value, in this case AccountId
	}
	...
	public boolean withdraw(Money money, AccountId targetAccountId) {
		...
		Activity withdrawal = new Activity(
				...
				LocalDateTime.now(),
				money);
		this.activityWindow.addActivity(withdrawal); //matter to add activity to ActivityWindow
		return true;
	}
